...
# configuration列を取り除く
mavg  i=xx0.csv k=configuration,FAdd,FSAdd f=RCGX_,RCGY_,RCGA_,TCX_,TCY_,MPosiRecX_,MPosiRecY_,MPosiRecA_,MPosiRecZ_,MNTCX_,MNTCY_,MNTCA_,TLX_,TLY_ |
...
mcal c='sqrt(${TLX_}^2+${TLY_}^2)' a=TLL o=$oDir/rcgtc_feeder.csv