...
# 出力ディレクトリ
oDir=out/210_feeder_matrix_avg
mkdir -p $oDir
...
# configuration 40 を取り除く
# X,Yについて、√X^2+Y^2を計算する
mavg  i=xx3.csv k=configuration,FAdd,FSAdd f=RCGX_,RCGY_,RCGA_,TCX_,TCY_,MPosiRecX_,MPosiRecY_,MPosiRecA_,MPosiRecZ_,MNTCX_,MNTCY_,MNTCA_,TLX_,TLY_ |
...
mjoin -n k=configuration,FAdd,FSAdd f=errorRate m=out/100_countMountPickupFeeder/mpf_error_by_feeder.csv o=$oDir/avg_feeder_${zettaichi}.csv
