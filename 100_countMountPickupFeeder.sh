...
mcut f=File,No.:no,datetime,day,hour,minute,configuration,boardSerial,boardID,FAdd,FSAdd,Pickup,PMiss,RMiss,DMiss,MMiss,HMiss,TRSMiss,Mount |
...
mjoin              m=$iDir/Information.csv k=File f=Serial,SerialStatus,Code,BcrStatus,ProductID,Rev,PlanID,Output,LotName,LotNumber o=xxout_mpf_joined
...
msum    i=xxout_mpf_joined_inc k=configuration,FAdd,FSAdd f=pickup_inc,pmiss_inc,mount_inc |
